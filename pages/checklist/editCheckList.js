...
const EditCheckList = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    dateVisited: filterCheckList?.[0]?.attributes?.dateVisited,
    timeVisited: filterCheckList?.[0]?.attributes?.timeVisited,
    visitedBy: filterCheckList?.[0]?.attributes?.visitedBy,
    sop: filterCheckList?.[0]?.attributes?.sop || [],
    equipment: filterCheckList?.[0]?.attributes?.equipment || [],
